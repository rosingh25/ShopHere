    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> RegisterAdmin(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var roleShop = new RoleStore<IdentityRole>(new ApplicationDbContext());
                    var roleAdmin = new RoleManager<IdentityRole>(roleShop);
                    await roleAdmin.CreateAsync(new IdentityRole("Admin"));
